...
export const HeroPage = () => {
    ...
    const { data: heroResponse, isError } = useHero(idSlug)

    if (isError) return <Navigate to={"/"}></Navigate>
    if (!heroResponse) {
    ...
    const totalPower =
        heroResponse.strength + heroResponse.intelligence + heroResponse.speed + heroResponse.durability
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-4">
                                <Badge className={`${getCategoryColor(heroResponse.category)} text-white`}>
                                    {heroResponse.category}
                                </Badge>
                                <Badge className={`${getStatusColor(heroResponse.status)} text-white`}>{heroResponse.status}</Badge>
                                <Badge variant="secondary" className="bg-white/20 text-white border-white/30">
                                    {heroResponse.universe}
                                </Badge>
                            </div>

                            <h1 className="text-4xl md:text-6xl font-bold mb-2">{heroResponse.alias}</h1>
                            <p className="text-xl text-blue-200 mb-4">{heroResponse.name}</p>
                            <p className="text-lg text-gray-300 max-w-2xl">{heroResponse.description}</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <div className="text-3xl font-bold text-red-600 mb-2">{heroResponse.strength}</div>
                                    <Progress value={heroResponse.strength * 10} className="h-2" />
                                </CardContent>
                            </Card>
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <div className="text-3xl font-bold text-purple-600 mb-2">{heroResponse.intelligence}</div>
                                    <Progress value={heroResponse.intelligence * 10} className="h-2" />
                                </CardContent>
                            </Card>
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <div className="text-3xl font-bold text-yellow-600 mb-2">{heroResponse.speed}</div>
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <div className="text-3xl font-bold text-green-600 mb-2">{heroResponse.durability}</div>
                                    <Progress value={heroResponse.durability * 10} className="h-2" />
                                </CardContent>
                            </Card>
                        </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <Progress value={heroResponse.strength * 10} className="h-4" />
                                        </div>
                                        <div className="w-12 text-right font-bold">{heroResponse.strength}/10</div>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="w-24 text-sm font-medium">Inteligencia</div>
                                        <div className="flex-1">
                                            <Progress value={heroResponse.intelligence * 10} className="h-4" />
                                        </div>
                                        <div className="w-12 text-right font-bold">{heroResponse.intelligence}/10</div>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="w-24 text-sm font-medium">Velocidad</div>
                                        <div className="flex-1">
                                            <Progress value={heroResponse.speed * 10} className="h-4" />
                                        </div>
                                        <div className="w-12 text-right font-bold">{heroResponse.speed}/10</div>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="w-24 text-sm font-medium">Resistencia</div>
                                        <div className="flex-1">
                                            <Progress value={heroResponse.durability * 10} className="h-4" />
                                        </div>
                                        <div className="w-12 text-right font-bold">{heroResponse.durability}/10</div>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-center py-8">
                                    ...
                                    <h3 className="text-2xl font-bold text-green-700 mb-2">{heroResponse.team}</h3>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center py-2">
                                        ...
                                        <Badge className={`${getStatusColor(heroResponse.status)} text-white`}>
                                            {heroResponse.status}
                                        </Badge>
                                    </div>
                                </CardContent>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    <div className="flex justify-between items-center py-2 border-b">
                                        ...
                                        <span className="font-semibold">{heroResponse.universe}</span>
                                    </div>
                                    <div className="flex justify-between items-center py-2 border-b">
                                        <span className="text-gray-600">Primera Aparición:</span>
                                        <span className="font-semibold">{heroResponse.firstAppearance}</span>
                                    </div>
                                    <div className="flex justify-between items-center py-2">
                                        <span className="text-gray-600">Años Activo:</span>
                                        <span className="font-semibold">
                                            {new Date().getFullYear() - Number.parseInt(heroResponse.firstAppearance)} años
                                        </span>
                                    </div>
                                </CardContent>
                            </Card>
