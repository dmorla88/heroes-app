...
describe('getHeroesByPageAction', () => {
    ...
    test('should return the correct heroes when page is not nummer', async () => {
        ...
        const result = await getHeroesByPageAction(NaN)
    ...
    test('should return the correct heroes when correct params', async () => {
